...
WHEN YOU RECEIVE A MESSAGE asking you to analyze a document, produce a structured breakdown of the contract below. Extract: all parties, financial terms, key clauses with exact page/section references, commitments, deadlines, and anything that a reviewer should examine closely.
